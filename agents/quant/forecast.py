...
def forecast_market(market_key, market_data, facts, horizon_hours=4, live=False):
    ...
    # Momentum forecast: use projected momentum value with scaled coefficient (INCREASED!)
    momentum_coefficient = 0.0005 * horizon_scale  # increased from 0.00001 to 0.0005 (50x)
