...
def forecast_market(market_key, market_data, facts, horizon_hours=4, live=False):
    ...
    # Momentum forecast: use projected momentum value with scaled coefficient (reduced from 0.0005 to 0.0002)
    momentum_coefficient = 0.0002 * horizon_scale  # further reduced for more conservative predictions
