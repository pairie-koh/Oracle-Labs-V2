...
def forecast_market(market_key, market_data, facts, horizon_hours=4, live=False):
    ...
    # Reduced coefficient to minimize prediction errors
    momentum_coefficient = 0.0001 * horizon_scale
    ...
    # Reduced coefficient to stay much closer to current price
    reversion_coefficient = 0.00015 * horizon_scale
