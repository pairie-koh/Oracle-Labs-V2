...
def forecast_market(market_key, market_data, facts, horizon_hours=4, live=False):
    ...
    # Momentum forecast: use projected momentum value with scaled coefficient (increased for better directional accuracy)
    momentum_coefficient = 0.0002 * horizon_scale  # increased from 0.00005 to 0.0002 for stronger directional signals
