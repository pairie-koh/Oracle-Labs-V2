...
def forecast_market(market_key, market_data, facts, horizon_hours=4, live=False):
    ...
    # Momentum forecast: use projected momentum value with scaled coefficient (reduced from 0.002 to 0.0005)
    momentum_coefficient = 0.0005 * horizon_scale  # reduced for more conservative predictions
