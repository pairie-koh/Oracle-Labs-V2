...
def forecast_market(market_key, market_data, facts, horizon_hours=4, live=False):
    ...
    # Momentum forecast: use projected momentum value with scaled coefficient (reduced for better MSE)
    momentum_coefficient = 0.00005 * horizon_scale  # reduced from 0.0002 to 0.00005 for more conservative predictions
