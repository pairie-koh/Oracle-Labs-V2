...
def forecast_market(market_key, market_data, facts, horizon_hours=4, live=False):
    ...
    # Momentum forecast: use projected momentum value with scaled coefficient (reduced from 0.001 to 0.0001)
    momentum_coefficient = 0.0001 * horizon_scale  # reduced 10x for more conservative predictions
